...
# 在RCNN结束后开启VERTEX的训练，此时只更新VERTEX分支上的参数
_C.MODEL.VERTEX_AFTER_RCNN = False
_C.MODEL.VERTEX_ONLY = False
...
# config of RNN HEAD
_C.MODEL.ROI_RNN_HEAD = CN()
# 是否为VERTEX分支单独设计FPN
_C.MODEL.ROI_RNN_HEAD.INDIVIDUAL_FPN = False
# porposals外扩倍数
_C.MODEL.ROI_RNN_HEAD.BOX_ENLARGE_RATIO = 0.2
_C.MODEL.ROI_RNN_HEAD.FEATURE_EXTRACTOR = "RNNFPNFeatureExtractor"
_C.MODEL.ROI_RNN_HEAD.POOLER_RESOLUTION = 28
_C.MODEL.ROI_RNN_HEAD.POOLER_SAMPLING_RATIO = 0
_C.MODEL.ROI_RNN_HEAD.POOLER_SCALES = (1.0 / 16,)
_C.MODEL.ROI_RNN_HEAD.MLP_HEAD_DIM = 1024
_C.MODEL.ROI_RNN_HEAD.CONV_LAYERS = (256, 256, 256, 256)
_C.MODEL.ROI_RNN_HEAD.USE_GN = False
_C.MODEL.ROI_RNN_HEAD.USE_BN = True
_C.MODEL.ROI_RNN_HEAD.DILATION = 1
_C.MODEL.ROI_RNN_HEAD.MAX_LEN = 32
_C.MODEL.ROI_RNN_HEAD.HIDDEN_DIM = [64, 16]
_C.MODEL.ROI_RNN_HEAD.KERNEL_SIZE = 3
_C.MODEL.ROI_RNN_HEAD.N_LSTM_LAYERS = 2
# 进入rnn的box最大数
_C.MODEL.ROI_RNN_HEAD.SAMPLE_NUM = 8
# train的各种设置
_C.MODEL.ROI_RNN_HEAD.TRAIN_TEMP = 0.
_C.MODEL.ROI_RNN_HEAD.TRAIN_BEAM_SIZE = 1
_C.MODEL.ROI_RNN_HEAD.TRAIN_FP_BEAM_SIZE = 1
_C.MODEL.ROI_RNN_HEAD.GRAD_CLIP = 40
# test的各种设置
_C.MODEL.ROI_RNN_HEAD.TEST_TEMP = 0.
_C.MODEL.ROI_RNN_HEAD.TEST_BEAM_SIZE = 1
_C.MODEL.ROI_RNN_HEAD.TEST_FP_BEAM_SIZE = 1
# LSTM设置
_C.MODEL.ROI_RNN_HEAD.RETURN_ATTENTION = False
_C.MODEL.ROI_RNN_HEAD.DT_THRESOLD = 2
# LOSS设置
_C.MODEL.ROI_RNN_HEAD.FP_VERTEX_WEIGHT = 200
_C.MODEL.ROI_RNN_HEAD.FP_EDGE_WEIGHT = 200
_C.MODEL.ROI_RNN_HEAD.SOFT_VERTEX_LABEL = False
_C.MODEL.ROI_RNN_HEAD.SOFT_EDGE_LABEL = False
_C.MODEL.ROI_RNN_HEAD.VERTEX_SOFT_VALUE = 0.7
_C.MODEL.ROI_RNN_HEAD.EDGE_SOFT_VALUE = 0.8
_C.MODEL.ROI_RNN_HEAD.LOSS_FACTOR = 1.0
# POSTPROCESS设置
_C.MODEL.ROI_RNN_HEAD.POSTPROCESS_MASKS = False
